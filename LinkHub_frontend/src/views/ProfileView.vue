    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="main-center col-span-3 space-y-4">
            <div class="bg-white border border-gray-200 rounded-lg">
                ...
                <div class="p-4">
                    <textarea v-model="body" class="p-4 w-full bg-gray-100 rounded-leg" placeholder="what are you think about"></textarea>
                </div>

                <div class="bg-white border border-gray-200 rounded-lg">
                    <a href="#" class="inline-block py-4 px-6 bg-blue-600 text-white rounded-leg">Attach Photo Here</a>
                    <button class="inline-block py-4 px-6 bg-green-400 text-white rounded-leg">Ok Post It</button>
                </div>
            </form>
            </div>
